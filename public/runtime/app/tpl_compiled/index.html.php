...
<div class="wrap_full_w">
	<?php if ($this->_var['cate_list_product']): ?>
		<?php $_from = $this->_var['cate_list_product']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cate_list_0_01217400_1494117718');if (count($_from)):
    foreach ($_from AS $this->_var['cate_list_0_01217400_1494117718']):
?>
		 <?php if ($this->_var['cate_list_0_01217400_1494117718']['duobao_list']): ?>
		<div class="index-goods-list" style="width: 1201px">
			<h1 class="main-title"><?php echo $this->_var['cate_list_0_01217400_1494117718']['name']; ?>
			<a href="<?php
...
?>" class="title-more">更多商品，点击查看>></a>
			...
			<a href="<?php
echo parse_url_tag("u:index|duobaos|"."id=".$this->_var['cate_list']['id']."".""); 
?>" class="title-more"><img src="<?php echo $this->_var['cate_list_0_01217400_1494117718']['image']; ?>" width="238" height="400"  ></a>
			<!-- <?php echo show_adv("cate_banner","","238","400");  ?> -->
			</li>
			<?php $_from = $this->_var['cate_list_0_01217400_1494117718']['duobao_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'hot_duobao');if (count($_from)):
    foreach ($_from AS $this->_var['hot_duobao']):
?>
				<li class="goods ui-item">
				<div class="hover_line">
