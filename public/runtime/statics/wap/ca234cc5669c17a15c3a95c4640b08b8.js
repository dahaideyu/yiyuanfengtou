...
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('7 4B(){4y.4p(-1)}7 3W(C){c K=\'{"3E":"\'+C[\'3E\']+\'","1X":{\';2O(c k 57 C[\'1X\']){K+=\'"\'+k+\'":"\'+C[\'1X\'][k]+\'",\'}K=K.23(0,K.t-1);K+=\'}}\';v K}7 59(){$("#2y-1n").1q(\'R\',7(){$(".2y-1n").5c(\'5q\')})}7 5t(C){$("a").f("B",C.B+"&o="+1x.2s())}7 61(1u){b(1u==1){$.1p("支付成功",7(){E.1J()})}p b(1u==2){}p b(1u==6){$.1p("支付接口异常",7(){E.1J()})}p b(1u==4){$.1p("取消支付",7(){E.1J()})}p{E.1J()}}c 1L=1f;c 1S="";7 2h(2S){1S=2S;$(".X").3h();b($(".X").t>0){$(".X").5v("<12 q=\'1c-1y\'></12>");$(".1c-1y").h("努力加载中...~")}$(y).2D(7(){c 5w=\'5x-5y-Y-3S\';c 2P=2g($(y).3R())+2g($(y).3c())+3O;b($(1v).3R()<=2P){b(1L)v;c 3i=$(".X").u("J.31").26();b(3i.t>0){c m=$(".X").u("J.31").26().f("B");$(".1c-1y").h("努力加载中...~");1L=O;$.1E({m:m,1O:"3l",I:7(h){$(".39").4z($(h).u(".39").h());$(".X").h($(h).u(".X").h());c 4D=\'4G-4F-4E\';1L=1f;$(".1c-1y").h("");b(11 1S=="7"){1S()}},24:7(){}})}p{$(".1c-1y").h("已经到底部了...~")}}})}$(1v).2U(7(){3f();3a();2V();3e();3m();33();2h();3A();b(11(2l)!=\'1D\'){18.1X({4r:1f,2l:2l,3j:3j,2R:2R,2J:2J,4s:[\'2W\',\'30\',\'2H\',\'2I\',\'2M\',]});18.2U(7(){18.2W({1m:1F,1z:N,1r:N,L:L,I:7(){},1s:7(){}});18.30({1m:1F,1z:N,1r:N,L:L,I:7(){},1s:7(){}});18.2H({1m:1F,1z:N,1r:N,L:L,I:7(){},1s:7(){}});18.2I({1m:1F,1z:N,1r:N,L:L,I:7(){},1s:7(){}});18.2M({1m:1F,1z:N,1r:N,L:L,I:7(){},1s:7(){}})})}$(\'.2K-1Z\').51("R",7(){$(\'.2K-4T\').4S()});38(4M);$(".4n").R(7(){$(".4K").2X();$(".4J").2X()});$(".3q").u(".4O").1q("R",7(){$(".3q").3h();c 17=3u 3z();17.1Q="4P";$.1E({m:1M,C:17,1O:"3l",I:7(){},24:7(o){}})});2e{1o.3Y()}2j(3B){}$(".3X").R(7(){c 1U=$(3d).f("1U");$.35({\'1m\':\'虚拟商品信息\',\'3Z\':1U,\'40\':{\'确定\':{\'q\':\'2i\',\'1U\':7(){}}}})})});7 41(2c,28){$.1E({m:1M,C:{"1Q":"43","2c":2c,"28":28},1O:"3C",2A:"K",I:7(C){}})}7 38(1e){1e?1e=1e:1e=50;$(y).2D(7(){c s=$(y).3c();b(s>1e){b($(".2b").4m(":4h"))$(".2b").44(2f)}p{$(".2b").2x(2f)}})};7 4k(1W,P){$(1W).R(7(){b($(P).1l(\'1Z\')){$(P).x(\'1Z\').10(\'2u\')}p{$(P).x(\'2u\').10(\'1Z\')}})}7 46(1W,P,1Y,2B){$(1W).R(7(){b($(P).1l(1Y)){$(P).x(1Y).10(2B)}p{$(P).x(2B).10(1Y)}})}7 33(){$("a.35").1q("R",7(){c B=$(3d).f("B");$.45("确认操作吗？",7(){E.B=B});v 1f})}7 3e(){$.22=7(){$("3t[4e][!4l]").4j({4f:4L})};$.22();$(y).1q("5I",7(e){$.22()});$(y).1q("2D",7(e){$.22()})}7 3m(){$("5V.H-5U[j!=\'j\']").19(7(i,2E){$(2E).f("j","j");$(2E).5Y()})}7 54(G){b(G.60){c 1h="<J q=\'5Z\'>"+G.3F+"5T</J>";b(G.27||G.2w||G.2v){1h+="<J q=\'5S\'>";b(G.2v)1h+=G.2v+"&2G;";b(G.2w)1h+=G.2w+"&2G;";b(G.27)1h+=G.27+"&2G;";1h+="</J>"}}}c 16=20;c 1t=0;7 2V(){$("V.H-V[j!=\'j\']").19(7(i,o){1t++;c U="2Z"+1x.2Y(1x.2s()*2L)+""+1t;c 1T={U:U};$(o).f("j","j");$(o).2N(1T)});$("V.H-1n[j!=\'j\']").19(7(i,o){1t++;c U="2Z"+1x.2Y(1x.2s()*2L)+""+1t;c 1T={U:U,6f:"6e"};$(o).f("j","j");$(o).2N(1T)});$(1v.6k).R(7(e){b($(e.1N).f("q")!=\'H-V-3k\'&&$(e.1N).2C().f("q")!=\'H-V-3k\'){$(".H-V-1n").2x("37");$(".H-V").x("3b");16=20}p{b(16!=20&&16.f("U")!=$(e.1N).2C().f("U")){$(16).u(".H-V-1n").2x("37");$(16).x("3b")}16=$(e.1N).2C()}})}7 3f(){$("29.H-29[j!=\'j\']").19(7(i,o){$(o).f("j","j");$(o).6a()})}7 3a(){$(".H-62[j!=\'j\'],.H-5i[j!=\'j\']").19(7(i,o){$(o).f("j","j");$(o).5g()})}7 5j(){$(".5k-P").u("29.5l[1H!=\'1H\']").19(7(i,o){$(o).f("1H","1H");c D=$(o).f("D");c 1G=$(o).26();1G.f("32",$(o).f("32"));1G.f("D",D);b(2p(D)>0)34($(1G),D)})}7 34(g,D){$(g).3n();$(g).x($(g).f("13"));$(g).x($(g).f("13")+"3o");$(g).x($(g).f("13")+"3p");$(g).f("13","36");$(g).10("36");$(g).u("J").h("重新获取("+D+")");$(g).f("D",D);$(g).55(2f,7(){c 1w=2p($(g).f("D"));1w--;$(g).u("J").h("重新获取("+1w+")");$(g).f("D",1w);b(1w==0){$(g).3n();$(g).x($(g).f("13"));$(g).x($(g).f("13")+"3o");$(g).x($(g).f("13")+"3p");$(g).f("13","3g");$(g).10("3g");$(g).u("J").h("发送验证码")}})}$.5p=7(Q,t,1I){c 1k=$.1C(Q).t;b(1I)1k=$.2q(Q);v 1k>=t};$.5C=7(Q,t,1I){c 1k=$.1C(Q).t;b(1I)1k=$.2q(Q);v 1k<=t};$.2q=7(1b){1b=$.1C(1b);b(1b=="")v 0;c t=0;2O(c i=0;i<1b.t;i++){b(1b.5H(i)>5G)t+=2;p t++}v t};$.5F=7(Q){b($.1C(Q)!=\'\'){c 1P=/^(1[5z]\\d{9})$/;v 1P.14($.1C(Q))}p v O};$.5s=7(2Q){c 1P=/^\\w+((-\\w+)|(\\.\\w+))*\\@[A-2n-2m-9]+((\\.|-)[A-2n-2m-9]+)*\\.[A-2n-2m-9]+$/;v 1P.14(2Q)};7 5u(1a){c 2T=/[a-z]+/;c 3P=/[A-Z]+/;c 3K=/[0-9]+/;c 3M=/\\W+/;c 3N=/\\S{6,8}/;c 3r=/\\S{9,}/;c n=0;b(2T.14(1a))n++;b(3P.14(1a))n++;b(3K.14(1a))n++;b(3M.14(1a))n++;b(3N.14(1a))n++;b(3r.14(1a))n++;b(n>=1&&n<=2)n=0;p b(n>=3&&n<=4)n=1;p b(n>=5&&n<=6)n=2;p n=-1;v n}7 5r(){$(".15").19(7(i,15){c T=$(15).f("C");c 3y=2p(T-1);c 1R=\'\';c 2k=0;c 3J=\'<i q="r-l l-M"></i>\'+\'<i q="r-l l-M"></i>\'+\'<i q="r-l l-M"></i>\'+\'<i q="r-l l-M"></i>\'+\'<i q="r-l l-M"></i>\';$(15).h(3J);b(T.25(".")>0){1R="0"+T.23(T.25("."),T.t);2k=(2g(1R)*3O).5E(1)}b(T>1)$(15).u(".r-l:5D("+3y+")").x("l-M").10("l-M-2i");p $(15).u(".r-l").x("l-M").10("l-M-2i");b(1R.t>0){$(15).u(".r-l").5A(T).h(\'<i q="r-l l-M-5B" 5o="5b:\'+2k+\'%"></i>\')}})}7 5d(2o,o){c 17=3u 3z();17.1Q="5a";17.2o=2o;$.1E({m:1M,C:17,2A:"K",I:7(F){c 1d=F.1d;c h=F.h;b(1d==1){$(o).h(h)}b(1d==2){$(o).h(h)}b(1d==3){$.56(h)}b(1d==4){$.1p(F.3F,7(){b(F.2z){y.E=F.2z}})}},24:7(58){}})}7 2r(){c m=E.B;b(m.25("?")==-1){m+="?2r=1"}p{m+="&2r=1"}E.B=m}7 5e(){1o.2a("5f")}7 5m(){1o.2a("5n")}7 5h(){1o.2a("5J")}7 69(3v){$.1E({m:1M,C:{"1Q":"6b","68":3v},1O:"3C",2A:"K",I:7(F){b(F.67==0)E.B=F.2z;p{$.1p("取消授权")}}})}7 64(m){2e{1o.65(\'{"m":"\'+m+\'"}\')}2j(3B){y.2u(m)}}7 3G(F){c 1K=1f;b(F==1){b($(\'#1B-1A-1i\').1l(\'1B-1A-1i\')){1K=O}}p{b(F.1l(\'1B-1A-1i\')){1K=O}}b(1K==O){66({6c:"#1B-1A-1i",6d:".2y 3D",6j:".6i 3D",6g:"63",5P:O,5Q:O,5R:5O})}}7 3A(){b($(\'#1j\').1l(\'1j\')){c m=y.E.B+\'&5N=1\';c 3s=3I();c 3L=\'<12 q="2t-2F">\'+\'<12 q="1i"><12>\'+\'<3t 5K="\'+3s+\'/5L/5M/5X/5W.6l" />\'+\'<J q="r">下拉开始刷新</J>\'+\'</12></12></12>\';$(\'#1j\').6h(3L);c $1g=$(\'.2t-2F .r\');c 4d=$(\'.1j\').4g({$4a:$(\'.1j\'),$4b:$(\'.2t-2F\'),4c:20,m:m,49:O,48:{47:7(){$1g.r(\'松开开始刷新:\')},4i:7(){$1g.r(\'数据刷新中···\')},I:7(1V){$(\'#1j\').h($(1V).h());b(11(42)!=\'1D\'){3G($(1V).u(\'.1B-1A-1i\'));1c=2;3U=O;3T=0;3V()}b(11($(1V).u(\'.w-53-4Q\').f(\'q\'))==\'4R\'){4N()}b($(".X").1l(\'4Z\')){2h()}b(11(52)!=\'1D\'){4Y();4X();4U()}b(11(4V)!=\'1D\'){4W();4I();4H();4u()}b(11(4v)!=\'1D\'){4w()}$1g.r(\'数据刷新成功！\')},4t:7(){$1g.r(\'下拉刷新结束\')},24:7(){$1g.r(\'找不到请求地址,数据刷新失败\')}}})}}7 3I(){c 2d=y.1v.E.B;c 21=y.1v.E.4o;c 3w=2d.25(21);c 3x=2d.23(0,3w);c 3H=21.23(0,21.4q(1).4x(\'/\')+1);v(3x+3H)}7 4C(3Q){2e{b(11(4A(3Q))=="7"){v O}}2j(e){}v 1f}',62,394,'|||||||function||||if|var|||attr|btn|html||init||icon|url|result||else|class|text||length|find|return||removeClass|window|||href|data|lesstime|location|obj|signin_result|ui|success|span|json|imgUrl|star|shar_url|true|panel|value|click||avg_point|id|select||scroll_bottom_page|||addClass|typeof|div|rel|test|stars|droped_select|query|wx|each|pwd|str|page|tag|min_height|false|statu|msg|box|loading_container|strLength|hasClass|title|drop|App|showErr|bind|link|cancel|uiselect_idx|state|document|lt|Math|load|desc|adv|index|trim|undefined|ajax|page_title|divbtn|init_sms|isByte|reload|is_exe|infinite_loading|AJAX_URL|target|type|reg|act|start_half|init_scroll_bottom_back|op|action|response|clickon|config|switchA|close|null|pathName|refresh_image|substring|error|indexOf|next|point|dev_token|button|login_sdk|gotop|dev_type|curWwwPath|try|1000|parseFloat|init_scroll_bottom|gray|catch|half_width|appId|z0|Za|uid|parseInt|getStringLength|weixin_login|random|loading|open|money|score|fadeOut|hd|jump|dataType|switchB|parent|scroll|ipt|warp|nbsp|onMenuShareQQ|onMenuShareWeibo|signature|winner|10000000|onMenuShareQZone|ui_select|for|totalheight|val|nonceStr|callback|regex0|ready|init_ui_select|onMenuShareAppMessage|toggle|round|uiselect_|onMenuShareTimeline|current|form_prefix|init_ui_confirm|init_sms_code_btn|confirm|disabled|fast|gotoTop|scroll_bottom_list|init_ui_textbox|dropdown|scrollTop|this|init_ui_lazy|init_ui_button|light|hide|next_dom|timestamp|selected|POST|init_ui_starbar|stopTime|_hover|_active|Client|regex5|rootPath|img|new|jsonstr|pos|localhostPaht|start_cut|Object|init_pull_refresh|ex|post|ul|pay_sdk_type|info|init_touch_slide|projectName|getRootPath|star_html|regex2|p_fres_h|regex3|regex4|100|regex1|funcName|height|160725071|page_total|stop|init_auto_load_data|pay_sdk_json|fictitious_info|apns|message|buttons|js_apns|is_index_set|update_dev_token|fadeIn|showConfirm|changeclass|pullStart|callbacks|autoHide|el|loadingEl|sendData|pullRefresh|lazy|placeholder|pPullRefresh|hidden|start|ui_lazy|openclose|isload|is|h_search|pathname|go|substr|debug|jsApiList|end|init_get_buy_num|is_pk_index|init_pk_index|lastIndexOf|history|append|eval|js_back|isExitsFunction|total_set_height|071|725|160|init_change_cart_num|init_info_list|biz_pull_down|pull_down|LOADER_IMG|500|init_count_down|close_but|close_appdown|nums|string|remove|layer|init_buy_form|duobao_detail_info|init_duobao_cart|init_del_cart_item|init_cartnum_btn|fy||live|cart_index|countdown|show_signin_message|everyTime|showSuccess|in|ajaxobj|hd_drop|focus|width|toggleClass|focus_user|weixin_login_app|wxlogin|ui_textbox|weibo_login_app|textarea|init_sms_btn|login|ph_verify_btn|qq_login_app|qqlogin|style|minLength|active|init_dp_star|checkEmail|mt_rand|checkPwdFormat|after|scroll_height_set|FW|XS|34578|eq|half|maxLength|gt|toFixed|checkMobilePhone|255|charCodeAt|touchmove|xlwblogin|src|Tpl|main|ajax_refresh|750|autoPage|autoPlay|delayTime|signin_price|123|starbar|input|refreshing_1|images|ui_starbar|signin_msg|status|js_pay_sdk|textbox|leftLoop|open_url|open_type|TouchSlide|err_code|param|js_login_sdk|ui_button|get_wx_app_userinfo|slideCell|titCell|hover|event|effect|before|bd|mainCell|body|gif'.split('|'),0,{}))
